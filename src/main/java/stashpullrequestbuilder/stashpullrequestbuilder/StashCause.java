...
public class StashCause extends Cause {
    ...
    public void setBuildStartCommentId(String buildStartCommentId) { this.buildStartCommentId = buildStartCommentId; }
